...
public class MapsActivity2 extends FragmentActivity {
    ...
    LatLng SPOT2 = new LatLng(24.801204,120.978137);
    LatLng SPOT3 = new LatLng(24.885128,121.287747);
    LatLng SPOT4 = new LatLng(25.021654, 121.535301);

        /*
        24.545001, 120.812032 聯大
        24.801204,120.978137 新竹玻璃工藝博物館
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(MapsActivity2.this, GetTravelName.class);
        ...
        Marker spot2 = map.addMarker(new MarkerOptions().position(SPOT2).title("新竹玻璃工藝博物館"));
        Marker spot3 = map.addMarker(new MarkerOptions().position(SPOT3).title("大溪老街"));
        Marker spot4 = map.addMarker(new MarkerOptions().position(SPOT4).title("國立台灣大學"));

        map.animateCamera(CameraUpdateFactory.newLatLngZoom(SPOT4, 14));
...
//            }
        ...
        String url = getDirectionsUrl(24.545001 , 120.812032 , 24.801204,120.978137);
        DownloadTask downloadTask = new DownloadTask();
        downloadTask.execute(url);

        String url2 = getDirectionsUrl(24.801204,120.978137 , 24.885128,121.287747);
        DownloadTask downloadTask2 = new DownloadTask();
        downloadTask2.execute(url2);

        String url3 = getDirectionsUrl(24.885128,121.287747 , 25.021654, 121.535301);
